                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">View & Edit Potensi</h5>
                        </div>
                        <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="badge bg-success">
                                                                <a class="btn-success" href="sekolah{{$data->id}}">Edit</a>
                                                            </span>
                                                            <span class="badge bg-danger">
                                                                <a class="btn-danger" href="delete/sekolah/{{$data->id}}">Delete</a>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                ...
                                                @foreach ($potensiumkm as $data )
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="badge bg-success">
                                                                <a class="btn-success" href="umkm{{$data->id}}">Edit</a>
                                                            </span>
                                                            <span class="badge bg-danger">
                                                                <a class="btn-danger" href="delete/umkm{{$data->id}}">Delete</a>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                ...
                                <div class="tab-pane fade" id="ibadah" role="tabpanel"
                                    ...
                                    <div class="card-body">
                                        <table class="table table-striped" id="table1">
                                            ...
                                            <tbody>
                                                @foreach ($potensiibadah as $data)
                                                    <tr>
                                                        <td>{{$data->nama_tempatibadah}}</td>
                                                        ...
                                                        <td>
                                                            <span class="badge bg-success">
                                                                <a class="btn-success" href="edit/ibadah/{{$data->id}}">Edit</a>
                                                            </span>

                                                            <span class="badge bg-danger">
                                                                <a class="btn-danger" href="delete/ibadah/{{$data->id}}">Delete</a>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                @endforeach
